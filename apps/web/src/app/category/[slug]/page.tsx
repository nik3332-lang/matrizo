...
const CATEGORY_BANNERS: Partial<Record<string, { src: string; width: number; height: number; alt: string }>> = {
  upvc: { src: '/images/upvc-pipes-category.jpg', width: 900, height: 596, alt: 'Stacked UPVC pipes' },
};
