/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 1591f696f7d8618617c8e25e0c629393)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	CACHE: KVNamespace;
	DB: D1Database;
	ORDER_TRACKER: DurableObjectNamespace<import("./src/index").OrderTrackerDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OrderTrackerDO";
	}
